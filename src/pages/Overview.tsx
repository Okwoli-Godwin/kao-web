...
const Overview = () => {
  return (
    <div className="w-[100%] flex justify-center mt-[90px] sm;mt-[50px] xsm:mt-[50px]">
        <div className="w-[80%] md:w-[90%] sm:w-[90%] xsm:w-[90%] flex justify-between md:flex-col-reverse sm:flex-col-reverse xsm:flex-col-reverse">
            <div className="w-[48%] h-[500px] rounded-[12px] overflow-hidden md:hidden sm:hidden xsm:hidden">
                <img src={img} alt="" className="w-[100%] h-[100%] object-cover"/>
            </div>

            <div className="flex flex-col h-[570px] md:h-[100%] xsm:h-[100%] sm:h-[100%] w-[48%] md:w-[100%] sm:w-[100%] xsm:w-[100%] mt-[25px]">
                <h3 className="text-[23px] sm:text-[26px] xsm:text-[24px] font-[600] w-[280px]">
                    KAO Overview
                </h3>
                ...
                <div className="w-[100%] h-[80px] bg-[#DE801C] mt-[20px] rounded-tr-[12px] pt-[1px] pr-[3px] rounded-bl-[12px]">
                    <div className="w-[100%] h-[100%] rounded-tr-[12px] bg-[#0030AD] mb-[-2px] rounded-bl-[12px] pt-[10px] pb-[15px] pl-[15px] flex flex-col">
                        <h3 className="text-[#fff] md:text-[19px] md:font-[500]">Values</h3>
                        <div className="flex items-center mt-[5px] md:justify-between">
                            <div className="flex items-center mr-[13px]">
                                <img src={img2} alt="" className="h-[20px] xsm:h-[18px]"/>
                                <p className="text-[#fff] ml-[7px] font-[300] text-[14px] xsm:text-[12px]">Innovation</p>
                            </div>
                            <div className="flex items-center mr-[13px]">
                                <img src={img2} alt="" className="h-[20px] xsm:h-[18px]"/>
                                <p className="text-[#fff] ml-[7px] font-[300] text-[14px] xsm:text-[12px]">Inclusivity</p>
                            </div>
                            <div className="flex items-center mr-[13px]">
                                <img src={img2} alt="" className="h-[20px] xsm:h-[18px]"/>
                                <p className="text-[#fff] ml-[7px] font-[300] text-[14px] xsm:text-[12px]">Customer-Centricity</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-[100%] flex flex-col mt-[30px]">
                    <div className="flex flex-col">
                        <div className="flex items-center">
                            <img src={img3} alt="" />
                            <h4 className="ml-[10px] text-[16px] md:text-[18px] sm:text-[18px] xsm:text-[18px] font-[500] md:font-[600] sm:font-[600] xsm:font-[600]">Vision Statement</h4>
                        </div>
                    ...
                    <div className="flex flex-col mt-[20px]">
                        <div className="flex items-center">
                            <img src={img3} alt="" />
                            <h4 className="ml-[10px] text-[16px] font-[500] md:font-[600] sm:font-[600] xsm:font-[600] md:text-[18px] sm:text-[18px] xsm:text-[18px]">Mission Statement</h4>
                        </div>
                        <p className="text-[14px] mt-[3px] leading-[30px]">
