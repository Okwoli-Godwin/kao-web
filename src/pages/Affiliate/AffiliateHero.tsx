...
const AffiliateHero = () => {
  return (
    <div className="w-[100%] flex h-[100%] pt-[190px] flex-col items-center justify-center overflow-hidden">
        <div className="w-[90%] md:flex-wrap sm:flex-wrap xsm:flex-wrap flex items-center justify-between">
            <div className="w-[49%] md:w-[100%] sm:w-[100%] xsm:w-[100%] flex flex-col md:mb-[40px] sm:mb-[40px] xsm:mb-[40px]">
            ...
            <div className="w-[49%] md:w-[100%] sm:w-[100%] xsm:w-[100%] flex h-[300px] md:h-[400px] overflow-hidden rounded-[12px]">
                <img src={img2} alt="" className="w-[100%] h-[100%] object-cover"/>
            </div>
        </div>

        <div className="w-[100%] h-[450px] mt-[50px] bg-[red]">
        ...
        <div className="w-[90%] flex justify-between mt-[190px] md:mt-[0px] sm:mt-[40px] xsm:mt-[40px]  md:flex-wrap sm:flex-wrap xsm:flex-wrap">
            <div className="w-[24%] md:w-[100%] sm:w-[100%] xsm:w-[100%] md:mb-[25px] sm:mb-[25px] xsm:mb-[25px] h-[270px] border border-[#B4B4B4] rounded-[10px] py-[10px] px-[10px] flex flex-col">
                ...
                <h3 className="text-[16px] font-[500] w-[250px] mt-[12px] sm:text-[22px] xsm:-[22px]">
                    Individuals can apply as affiliate marketers
                </h3>

                <p className="text-[13px] font-[400] mt-[20px] md:text-[15px] sm:text-[15px] xsm:text[15px] ">
            ...
            <div className="w-[24%] md:mb-[25px] sm:mb-[25px] xsm:mb-[25px]  md:w-[100%] sm:w-[100%] xsm:w-[100%] h-[270px] border border-[#B4B4B4] rounded-[10px] py-[10px] px-[10px] flex flex-col">
                ...
                <p className="text-[13px] font-[400] md:text-[15px] sm:text-[15px] xsm:text[15px]  mt-[20px]">
            ...
            <div className="w-[24%] md:w-[100%] sm:w-[100%] xsm:w-[100%] h-[270px] border border-[#B4B4B4] rounded-[10px] py-[10px] px-[10px] flex flex-col">
                ...
                <h3 className="text-[16px] md:text-[22px] sm:text-[22px] xsm:-[22px] font-[500] w-[250px] mt-[12px]">
                    Payouts
                </h3>

                <p className="text-[13px] md:text-[15px] sm:text-[15px] xsm:text[15px] font-[400] mt-[20px]">
