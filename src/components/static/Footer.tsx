  ...
  return (
    <div className="w-[100%] flex-col bg-[#0030AD] pt-[20px] pb-[20px] mt-[90px] flex border-t-[7px] border-[#DE801C] items-center">
      <div className="w-[90%] flex justify-between md:flex-wrap sm:flex-wrap xsm:flex-wrap">
        ...
        <div className="w-[45%] md:w-[100%] sm:w-[100%] xsm:w-[100%] md-mt-[60px] flex justify-between sm:flex-wrap xsm:flex-wrap sm:mt-[40px] xsm:mt-[30px] sm:mb-[20px] xsm:mb-[20px]">
          ...
          <div className="flex flex-col  md:w-[150px] sm:mt-[40px] xsm:mt-[30px]">
            ...
            <p className="text-[#fff] font-[200] text-[15px] mt-[15px] md:text-[15px] sm:text-[15px] xsm:text-[15px]">Our culture</p>
            <p className="text-[#fff] font-[200] text-[15px] mt-[15px] md:text-[15px] sm:text-[15px] xsm:text-[15px]">See all opportunities</p>
            <p className="text-[#fff] font-[200] text-[15px] mt-[15px] md:text-[15px] sm:text-[15px] xsm:text-[15px]">Data & privacy</p>
          </div>
        </div>
      ...
      <div className="w-[100%] flex justify-center items-center">
        <p className="text-[13px] sm:text-[15px] md:text-[15px] xsm:text-[15px] text-[#fff] font-[300] mt-[20px]">Copyright © 2023 KAO.com. All rights reserved</p>
      </div>
    </div>
  )
}
